...
import { LanguageCreateNestedOneWithoutFilm_film_original_language_idTolanguageInput } from "../inputs/LanguageCreateNestedOneWithoutFilm_film_original_language_idTolanguageInput";
import { film_rating } from "../../enums/film_rating";

@TypeGraphQL.InputType("FilmCreateWithoutFilm_categoryInput", {})
export class FilmCreateWithoutFilm_categoryInput {
  ...
  @TypeGraphQL.Field(_type => LanguageCreateNestedOneWithoutFilm_film_language_idTolanguageInput, {
    nullable: false
  })
  language_film_language_idTolanguage!: LanguageCreateNestedOneWithoutFilm_film_language_idTolanguageInput;

  @TypeGraphQL.Field(_type => LanguageCreateNestedOneWithoutFilm_film_original_language_idTolanguageInput, {
    nullable: true
  })
  language_film_original_language_idTolanguage?: LanguageCreateNestedOneWithoutFilm_film_original_language_idTolanguageInput | undefined;
