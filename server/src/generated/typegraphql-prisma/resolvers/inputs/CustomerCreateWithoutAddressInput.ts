...
import { RentalCreateNestedManyWithoutCustomerInput } from "../inputs/RentalCreateNestedManyWithoutCustomerInput";
import { StoreCreateNestedOneWithoutCustomerInput } from "../inputs/StoreCreateNestedOneWithoutCustomerInput";

@TypeGraphQL.InputType("CustomerCreateWithoutAddressInput", {})
export class CustomerCreateWithoutAddressInput {
  ...
  @TypeGraphQL.Field(_type => RentalCreateNestedManyWithoutCustomerInput, {
    nullable: true
  })
  rental?: RentalCreateNestedManyWithoutCustomerInput | undefined;
}
