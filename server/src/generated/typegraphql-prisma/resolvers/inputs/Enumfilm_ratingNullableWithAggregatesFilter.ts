...
import { NestedEnumfilm_ratingNullableWithAggregatesFilter } from "../inputs/NestedEnumfilm_ratingNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { film_rating } from "../../enums/film_rating";

@TypeGraphQL.InputType("Enumfilm_ratingNullableWithAggregatesFilter", {})
export class Enumfilm_ratingNullableWithAggregatesFilter {
